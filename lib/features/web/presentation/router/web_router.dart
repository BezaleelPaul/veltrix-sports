...
class WebRouter {
  static final GoRouter router = GoRouter(
    initialLocation: '/',
    routes: [
      // Public routes with web scaffold
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/training',
            builder: (context, state) => const WebTrainingScreen(),
          ),
          GoRoute(
            path: '/events',
            builder: (context, state) => const WebEventsScreen(),
          ),
          GoRoute(
            path: '/coaches',
            builder: (context, state) => const WebCoachesScreen(),
          ),
          GoRoute(
            path: '/pricing',
            builder: (context, state) => const WebPricingScreen(),
          ),
          GoRoute(
            path: '/about',
            builder: (context, state) => const WebAboutScreen(),
          ),
          GoRoute(
            path: '/contact',
            builder: (context, state) => const WebContactScreen(),
          ),
        ],
      ),
      ...
      GoRoute(
        path: '/signup',
        builder: (context, state) => const WebSignupScreen(),
      ),
      // Dashboard (no public scaffold)
      GoRoute(
        path: '/dashboard',
      ...
      GoRoute(
        ...
        builder: (context, state) => const WebTicketsScreen(),
      ),
    ],
  );
}
